...
switch ($_POST['condition']) {
    ...
    case "SA":
        ...
        break;
    case "A":
        echo "<b>中古美品</b><br>多少の使用感・ダメージ等はあるが、比較的奇麗な商品※ランクは目安となりますので、下部詳細説明及び青いバナー内の詳細画像をご確認下さいませ。";
        break;
    case "AB":
        echo "<b>中古良品</b><br>使用感・多少のキズや汚れ等があるが、全体的には状態が良い商品※ランクは目安となりますので、下部詳細説明及び青いバナー内の詳細画像をご確認下さいませ。";
        break;
    case "B":
        echo "<b>中古品</b><br>日常的な使用感・一見してキズや汚れが目立つが、使用には差支えのない状態の商品※ランクは目安となりますので、下部詳細説明及び青いバナー内の詳細画像をご確認下さいませ。";
        break;
    case "BC":
