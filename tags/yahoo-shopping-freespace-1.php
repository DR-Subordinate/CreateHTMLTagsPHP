...
switch ($_POST['condition']) {
    case "N":
        ...
        break;
    case "S":
        echo "<b>未使用品（展示品またはアウトレット商品含む）</b><br>未使用品だが長期保管や展示により明確なダメージ等がある商品。アウトレット商品も含まれます。<br>※詳細は下記説明をご覧ください";
        break;
    case "SA":
        echo "<b>新品同様品</b><br>細かなあまり目立たないダメージがある程度の新品同様に奇麗なUSED商品";
        break;
    case "A":
        echo "<b>中古美品</b><br>多少の使用感・ダメージ等はあるが、比較的奇麗な商品<br>※ランクは目安となりますので、下部詳細説明及び青いバナー内の詳細画像をご確認下さいませ。";
        break;
    case "AB":
        echo "<b>中古良品</b><br>使用感・多少のキズや汚れ等があるが、全体的には状態が良い商品<br>※ランクは目安となりますので、下部詳細説明及び青いバナー内の詳細画像をご確認下さいませ。";
        break;
    case "B":
        echo "<b>中古品</b><br>日常的な使用感・一見してキズや汚れが目立つが、使用には差支えのない状態の商品<br>※ランクは目安となりますので、下部詳細説明及び青いバナー内の詳細画像をご確認下さいませ。";
        break;
    case "BC":
...
<tr>
  ...
  <td<?php if($_POST['condition'] == "SA"):?> bgcolor="#FFF766"<?php else: ?> bgcolor="#FFFFFF"<?php endif; ?> align="center" style="padding:8px; border:#dddddd solid 1px;">新<br>品<br>同<br>様<br>品</td>
