...
?>
<tr>
	<th style="font-size:24px;font-weight:bold;color:#bf0000;width:80px;"><?php echo $conditionText; ?></th>
	<td>
<?php 
switch ($_POST['condition']) {
    ...
    case "S":
        ...
        break;
    case "SA":
        echo "<b>超美品</b><br>細かなあまり目立たないダメージがある程度の新品同様に綺麗なUSED商品";
        break;
    case "A":
        echo "<b>中古美品</b><br>多少の使用感・ダメージ等はあるが、比較的綺麗な商品";
        break;
    case "AB":
