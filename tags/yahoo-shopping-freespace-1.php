...
<tr>
  ...
  <td<?php if($_POST['condition'] == "S"):?> bgcolor="#FFF766"<?php else: ?> bgcolor="#FFFFFF"<?php endif; ?> align="center" style="padding:8px; border:#dddddd solid 1px;">展<br>示<br>品<br>ま<br>た<br>は<br>ア<br>ウ<br>ト<br>レ<br>ッ<br>ト<br>商<br>品</td>
